...
function App() {
  ...
  const HomePage = () => (
    <div style={styles.card}>
      <div style={styles.badge}>Environment: Web 2 (Green)</div>
      <h1 style={styles.title}>Welcome to Web 2!</h1>
      <p style={styles.subtitle}>
        This is the Web 2 React application with hash-based routing and pink theme
      </p>
  ...
  const SecondPage = () => (
    <div style={styles.card}>
      <div style={styles.badge}>Environment: Web 2 (Green)</div>
      <h1 style={styles.title}>Welcome to 2nd Page in Web 2!</h1>
      <p style={styles.subtitle}>
        This is the second page of Web 2 application with unique pink theme
      </p>
      <div style={styles.nav}>
  ...
  const AboutPage = () => (
    <div style={styles.card}>
      <div style={styles.badge}>Environment: Web 2 (Green)</div>
      <h1 style={styles.title}>About Web 2</h1>
      <p style={styles.subtitle}>
        Blue/Green Deployment Demo Application
      </p>
      <div style={styles.info}>
        <h3 style={{color: '#f5576c', marginTop: 0}}>Features:</h3>
    ...
    return (
      <div style={styles.card}>
        ...
        <div style={styles.info}>
          ...
          <strong>Environment:</strong> Green Bucket
        </div>
        <div style={styles.nav}>
          <Link to="/" style={styles.button}>
            Home
